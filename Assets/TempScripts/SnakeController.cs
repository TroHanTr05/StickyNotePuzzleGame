...
public class SnakeController : MonoBehaviour
{
    ...
    {
        HandleInput();
        HandleThrowInput();   // <-- throwing on right-click
        MoveHead();
        UpdateHeadSpeed();
        RecordTrail();
        UpdateChain();
    ...
    void ThrowBall()
    {
        ...
        // Ignore collision with every snake collider (head + all segments)
    ...
    // Ignores collision between the thrown ball and ALL snake colliders
