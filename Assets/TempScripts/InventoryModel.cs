...
{
    // ── Singleton (optional convenience; swap for DI if preferred) ───────────
    public static readonly InventoryModel Instance = new();
    ...
    public bool Add(string itemTag)
    {
        ...
        if (!_items.Add(itemTag)) return false;          // already there
